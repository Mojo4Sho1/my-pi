...
5. **Meta-teams and expansion** (5a.7 complete; onboarding side quest T-22–T-26 complete; T-10 live build-team validation parked; Specialist Taxonomy Migration phase active — T-32 is the current target, see `docs/handoff/NEXT_TASK.md`)
