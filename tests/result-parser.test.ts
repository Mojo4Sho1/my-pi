...
\`\`\``;
  ...
  it("uses the provided sourceAgentId", () => {
    ...
    expect(parseSpecialistOutput(text, "specialist_builder").sourceAgent).toBe("specialist_builder");
    expect(parseSpecialistOutput(text, "specialist_planner").sourceAgent).toBe("specialist_planner");
    expect(parseSpecialistOutput(text, "specialist_reviewer").sourceAgent).toBe("specialist_reviewer");

    // Also for fallback cases
    expect(parseSpecialistOutput("no json here", "specialist_tester").sourceAgent).toBe("specialist_tester");
    expect(parseSpecialistOutput("", "specialist_builder").sourceAgent).toBe("specialist_builder");
  });
