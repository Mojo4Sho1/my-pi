...
export const SPECIALIST_REGISTRY_ENTRIES: PrimitiveRegistryEntry[] = [
  ...
  },
  {
    ...
    inputContract: [
      { name: "modifiedFiles", type: "string[]", required: false, description: "Files to test" },
      { name: "implementationSummary", type: "string", required: false, description: "What to validate" },
    ],
    outputContract: [
